...
public class CustomStatusEffect {
	...
	public static CustomStatusEffect fromNbt(NbtCompound nbtCompound, RegistryWrapper.WrapperLookup registryLookup) {
		return new CustomStatusEffect(
			CustomStatusEffectIdentifier.fromNbt(nbtCompound.getCompound("id"), registryLookup),
