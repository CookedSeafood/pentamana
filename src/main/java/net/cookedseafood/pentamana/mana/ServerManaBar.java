...
public final class ServerManaBar extends ManaBar {
     ...
     */
    public static ServerManaBar fromNbt(NbtCompound nbtCompound, RegistryWrapper.WrapperLookup wrapperLookup) {
        return ServerManaBar.of(ManaBar.fromNbt(nbtCompound, wrapperLookup))
            .withClientManaBar(ManaBar.fromNbt(nbtCompound.getCompound("clientManaBar"), wrapperLookup));
    }

    @Override
    public NbtCompound toNbt(RegistryWrapper.WrapperLookup wrapperLookup) {
        NbtCompound nbtCompound = super.toNbt(wrapperLookup);
        nbtCompound.put("clientManaBar", this.clientManaBar.toNbt(wrapperLookup));
        return nbtCompound;
    }
}
