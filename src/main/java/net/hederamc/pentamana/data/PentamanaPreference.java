...
public class PentamanaPreference {
    ...
    public static PentamanaPreference fromNbt(NbtCompound nbtCompound) {
        return new PentamanaPreference(
            ...
            nbtCompound.contains("pattern") ? ManaPattern.fromNbt(nbtCompound.getListOrEmpty("pattern")) : PentamanaConfig.DefaultPreference.pattern,
            ...
            nbtCompound.contains("charset") ? ManaCharset.fromNbt(nbtCompound.getListOrEmpty("charset")) : PentamanaConfig.DefaultPreference.charset,
